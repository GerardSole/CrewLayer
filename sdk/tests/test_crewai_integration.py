...
class TestCrewLayerMemoryProvider:
    def test_save_calls_memory_append(self) -> None:
        client = _make_client()
        provider = CrewLayerMemoryProvider(client=client, agent_id="a1", session_id="s1")
    ...
    def test_save_no_metadata_defaults_to_empty_dict(self) -> None:
        client = _make_client()
        provider = CrewLayerMemoryProvider(client=client, agent_id="a1")
    ...
    def test_search_uses_default_recall_limit(self) -> None:
        client = _make_client()
        provider = CrewLayerMemoryProvider(client=client, agent_id="a1", recall_limit=7)
    ...
    def test_search_overrides_limit(self) -> None:
        client = _make_client()
        provider = CrewLayerMemoryProvider(client=client, agent_id="a1", recall_limit=5)
    ...
    def test_search_overrides_score_threshold(self) -> None:
        client = _make_client()
        provider = CrewLayerMemoryProvider(client=client, agent_id="a1", min_similarity=0.35)
    ...
    def test_search_uses_default_min_similarity(self) -> None:
        client = _make_client()
        provider = CrewLayerMemoryProvider(client=client, agent_id="a1", min_similarity=0.4)
        provider.search("q")
        kw = client.memory.recall.call_args[1]
    ...
    def test_reset_is_noop(self) -> None:
        provider = CrewLayerMemoryProvider(client=_make_client(), agent_id="a1")
        provider.reset()  # must not raise

    def test_search_passes_agent_id(self) -> None:
        client = _make_client()
        provider = CrewLayerMemoryProvider(client=client, agent_id="my-agent")
...
class TestCrewLayerTaskLogger:
    ...
    def test_logs_action_on_call(self) -> None:
        client = MagicMock()
        logger = CrewLayerTaskLogger(client=client, agent_id="a1")
    ...
    def test_session_id_forwarded(self) -> None:
        client = MagicMock()
        logger = CrewLayerTaskLogger(client=client, agent_id="a1", session_id="s99")
